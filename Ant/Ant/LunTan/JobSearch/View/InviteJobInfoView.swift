...
class InviteJobInfoView: UITableView,UITableViewDelegate, UITableViewDataSource,UITextFieldDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            ...
            case 6:
                cell?.textLabel?.text = "签证要求"
            case 7:
                cell?.textLabel?.text = "经验要求"
            case 8:
                cell?.textLabel?.text = "工资水平"
            case 9:
